    ...
    <section class="w-full relative overflow-hidden py-14 lg:py-18 bg-gradient-to-r from-navy-base via-primary to-accent-coral animate-gradient-flow text-white">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 flex flex-col items-center gap-6">
            <div class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/20 backdrop-blur-md text-white font-mono text-xs font-bold">
                ...
                <span>BẮT ĐẦU CHIẾN DỊCH CÙNG CHÚNG TÔI</span>
            </div>
            <h2 class="font-headline text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-white max-w-3xl leading-tight">
                Bạn Có Dự Án Cần Triển Khai? Hãy Để Ekip CLM Đồng Hành Cùng Bạn
            </h2>
            <p class="font-body text-slate-100 text-sm sm:text-base max-w-2xl leading-relaxed">
                Chúng tôi cam kết đồng hành từ ý tưởng sơ khởi đến tác phẩm hoàn thiện đạt tiêu chuẩn chất lượng cao nhất.
            </p>
            <div class="flex flex-wrap items-center justify-center gap-4 pt-2">
                <a href="{{ route('contact') }}" class="px-8 py-3.5 rounded-full bg-white text-navy-base font-headline text-xs sm:text-sm font-bold shadow-xl hover:bg-amber-400 hover:text-navy-base transition-all">
                    Liên Hệ Trao Đổi Dự Án Ngay
                </a>
                <a href="{{ route('pricing') }}" class="px-7 py-3.5 rounded-full bg-black/25 hover:bg-black/40 text-white font-mono text-xs sm:text-sm font-bold backdrop-blur-md border border-white/20 transition-all flex items-center gap-2">
                    <span class="material-symbols-outlined text-[18px]">calculate</span>
                    <span>Xem Bảng Giá &amp; Dự Toán</span>
                </a>
            </div>
        </div>
    </section>
