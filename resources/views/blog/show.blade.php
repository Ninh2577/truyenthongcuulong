...
@section('title', ($post->meta_title ?: $post->title) . ' - Truyá»n ThÃ´ng Cá»­u Long')
...
<div class="w-full bg-[#FAFAFA] pt-24 lg:pt-32 pb-20">
    <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <nav class="flex items-center gap-2 text-[13px] font-medium text-slate-500 mb-8 lg:mb-12 flex-wrap">
            <a href="{{ route('home') }}" class="hover:text-orange-600 transition-colors">Trang chá»§</a>
            <span class="text-slate-300">/</span>
            <a href="{{ route('blog.index') }}" class="hover:text-orange-600 transition-colors">Táº¡p chÃ­</a>
            @if($post->category)
            <span class="text-slate-300">/</span>
                        ...
                        <div class="flex flex-wrap items-center justify-between gap-4 py-6 border-y border-slate-200/80 text-[13px] text-slate-600">
                            <div class="flex items-center gap-4">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span class="font-mono text-slate-500">{{ $post->published_at ? $post->published_at->format('d/m/Y') : '' }} Â· Äá»c 5 phÃºt</span>
                                </div>
                            </div>
