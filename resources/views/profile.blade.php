...
@section('meta_description', 'Khám phá hồ sơ năng lực trực tuyến dạng Scrollytelling của Công ty Truyền Thông Cửu Long.')
...
<main class="w-full pt-20 bg-surface">
    <div class="flex flex-col w-full relative">
        ...
        <section class="relative w-full min-h-[92vh] flex flex-col justify-between overflow-hidden bg-on-surface text-surface-container-lowest -mt-20 pt-28 pb-32 md:pb-36" id="hero">
            ...
            <div class="absolute inset-0 z-0 bg-cover bg-center" style="background-image: url('{{ asset('images/real-cameraman-production.jpg') }}')">
            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-start">
                    ...
                    <div class="lg:col-span-7 flex flex-col gap-6">
                        ...
                        <div class="relative mt-4 rounded-2xl bg-surface-container-lowest border border-surface-container-low overflow-hidden shadow-sm flex flex-col items-center justify-center p-8 group transition-shadow hover:shadow-md">
                            ...
                            <img alt="Truyền Thông Cửu Long Logo" class="w-full max-w-[280px] h-auto object-contain transition-transform duration-700 group-hover:scale-105 relative z-10" src="{{ asset('images/logo-profile.png') }}"/>
        ...
        <section class="w-full py-space-3xl md:py-space-4xl bg-surface-container-lowest" id="projects">
            <div class="max-w-container-max mx-auto px-gutter-mobile md:px-gutter-tablet lg:px-gutter-desktop">
                ...
                <div class="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-4">
                    ...
                    <a class="inline-flex items-center gap-1 font-label-md text-label-md text-primary font-bold hover:translate-x-1 transition-transform" href="{{ route('projects.index') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="rounded-2xl bg-surface-bright shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden flex flex-col group border border-surface-container-low">
                        <div class="h-52 w-full overflow-hidden relative bg-surface-container">
                            <img alt="Núi rừng Nam Tây Nguyên" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="{{ asset('images/partners/nam_tay_nguyen_real.jpg') }}" onerror="this.src='https://placehold.co/600x400/1e293b/fff?text=Nam+Tay+Nguyen'"/>
                    ...
                    <div class="rounded-2xl bg-surface-bright shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden flex flex-col group border border-surface-container-low">
                        <div class="h-52 w-full overflow-hidden relative bg-surface-container">
                            <img alt="Khu bảo tồn Láng Sen" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="{{ asset('images/partners/lang_sen_real.jpg') }}" onerror="this.src='https://placehold.co/600x400/1e293b/fff?text=Lang+Sen'"/>
                    ...
                    <div class="rounded-2xl bg-surface-bright shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden flex flex-col group border border-surface-container-low">
                        <div class="h-52 w-full overflow-hidden relative bg-surface-container">
                            <img alt="Nâm Nung Ultimate Challenge" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="{{ asset('images/partners/long_trekking_real.jpg') }}" onerror="this.src='https://placehold.co/600x400/1e293b/fff?text=Nam+Nung'"/>
                    ...
                    <div class="rounded-2xl bg-surface-bright shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden flex flex-col group border border-surface-container-low">
                        <div class="h-52 w-full overflow-hidden relative bg-surface-container">
                            <img alt="Đắk Nông UNESCO Global Geopark 2022" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="{{ asset('images/partners/geopark.jpg') }}"/>
                    ...
                    <div class="rounded-2xl bg-surface-bright shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden flex flex-col group border border-surface-container-low">
                        <div class="h-52 w-full overflow-hidden relative bg-surface-container">
                            <img alt="Hội nghị Hang động Thế giới ISV20" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="{{ asset('images/partners/cave.jpg') }}"/>
                    ...
                    <div class="rounded-2xl bg-surface-bright shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden flex flex-col group border border-surface-container-low">
                        <div class="h-52 w-full overflow-hidden relative bg-surface-container">
                            <img alt="Chuỗi Sự kiện Team Building 500+ Sinh Viên" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="{{ asset('images/partners/team_building.jpg') }}"/>
            ...
            <div class="max-w-container-max mx-auto px-gutter-mobile md:px-gutter-tablet lg:px-gutter-desktop">
                ...
                <div class="flex flex-col gap-6">
                    ...
                    <a href="https://cungchoi.com/" target="_blank" rel="noopener noreferrer" class="block rounded-2xl bg-surface-container-lowest p-6 md:p-8 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col lg:flex-row items-center gap-6 group relative overflow-hidden">
                        <div class="w-full lg:w-72 h-44 rounded-xl overflow-hidden shrink-0 relative">
                            <img alt="Cùng Chơi Gamification Studio" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" src="{{ asset('images/partners/cungchoi_logo.png') }}"/>
