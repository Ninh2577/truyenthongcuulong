<section class="w-full bg-surface bg-dot-grid-subtle py-12 lg:py-16 relative border-b border-slate-200/80 gsap-reveal-section" id="workflow-section" x-data="{ activeTab: 'tech' }">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Section Header -->
        <div class="text-center max-w-3xl mx-auto mb-10 lg:mb-12">
            <div class="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-sky-100/80 text-sky-800 font-mono text-xs font-bold border border-sky-200 mb-3">
                <span class="material-symbols-outlined text-[15px]">terminal</span>
                <span>ENGINEERING &amp; DELIVERY PIPELINE</span>
            </div>
            <h2 class="font-headline text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-navy-base">
                Quy Trình Phát Triển Chuẩn Mực &bull; Minh Bạch Từng Mốc
            </h2>
            <p class="font-body text-slate-600 text-base sm:text-lg mt-4 leading-relaxed">
                Mọi dự án công nghệ và giải pháp số tại Cửu Long tuân thủ quy trình kiểm soát chất lượng 6 giai đoạn nghiêm ngặt, từ kiến trúc phần mềm đến bàn giao mã nguồn 100%.
            </p>
            ...
            <div class="inline-flex p-1.5 rounded-full bg-slate-200/80 border border-slate-300 mt-8 shadow-inner">
                ...
                <button @click="activeTab = 'media'" 
                    ...
                    <span>Quy Trình Media Hỗ Trợ</span>
                </button>
            </div>
        </div>

        <!-- Tab 1: Tech & Platform Engineering Pipeline (Default & First) -->
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="p-6 rounded-2xl bg-white border border-slate-200/90 shadow-xs hover:border-sky-500/50 transition-all flex flex-col gap-3">
                    ...
                    <p class="font-body text-xs text-slate-600 leading-relaxed">
                        Phân tích yêu cầu nghiệp vụ, thiết kế cơ sở dữ liệu quan hệ, lựa chọn tech stack và kiến trúc bảo mật hệ thống an toàn đa tầng.
                    </p>
                </div>
                ...
                <div class="p-6 rounded-2xl bg-white border border-slate-200/90 shadow-xs hover:border-sky-500/50 transition-all flex flex-col gap-3">
                    ...
                    <p class="font-body text-xs text-slate-600 leading-relaxed">
                        Tối ưu Core Web Vitals chuẩn mực, cấu trúc schema JSON-LD, nén ảnh thế hệ mới WebP/AVIF và cấu hình CDN Cloudflare.
                    </p>
                </div>
        ...
        <!-- Tab 2: Film / Video Production Pipeline (Secondary Creative Support) -->
