...
<div class="w-full flex flex-col gap-1.5">
    ...
    <div class="relative">
        <textarea 
            ...
            {{ $attributes->merge([
                'class' => 'w-full px-3.5 py-2.5 rounded-xl border bg-white text-slate-900 placeholder:text-slate-400 font-body text-base sm:text-sm transition-all focus:outline-none focus:ring-2 resize-y ' . 
                    ($hasError 
