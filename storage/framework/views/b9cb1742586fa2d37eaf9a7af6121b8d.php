...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="<?php echo e(asset('images/logo-ttcl.png')); ?>">
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo e(asset('images/logo-ttcl.png')); ?>">
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('images/logo-ttcl.png')); ?>">
    
    <title><?php echo $__env->yieldContent('title', 'Truyền Thông Cửu Long - Creative Production Studio & Tech Agency'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('meta_description', 'Truyền Thông Cửu Long - Tổ hợp sáng tạo nội dung điện ảnh và công nghệ phần mềm hàng đầu Việt Nam.'); ?>">
    <link rel="canonical" href="<?php echo e(url()->current()); ?>">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website">
    <meta property="og:url" content="<?php echo e(url()->current()); ?>">
    <meta property="og:title" content="<?php echo $__env->yieldContent('title', 'Truyền Thông Cửu Long - Creative Production Studio & Tech Agency'); ?>">
    <meta property="og:image" content="<?php echo e(asset('images/logo-ttcl.png')); ?>">
    <meta property="og:description" content="<?php echo $__env->yieldContent('meta_description', 'Creative Production Studio & Tech Agency tại Cần Thơ & ĐBSCL.'); ?>">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(app()->environment('production') && env('GTM_ID')): ?>
...
<body class="bg-surface font-body text-on-surface antialiased selection:bg-primary selection:text-white <?php echo $__env->yieldContent('body-class'); ?>" x-data="{ mobileMenu: false, devPopup: false }">
    ...
    <div id="site-preloader" class="fixed inset-0 z-[9999] bg-[#0B132B] flex flex-col items-center justify-center transition-opacity duration-500">
        <div class="flex flex-col items-center gap-4">
            <div class="w-16 h-16 sm:w-20 sm:h-20 flex items-center justify-center animate-pulse">
                <img src="<?php echo e(asset('images/logo-ttcl.png')); ?>" alt="Logo Truyền Thông Cửu Long" class="w-full h-full object-contain">
            </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(env('GTM_ID')): ?>
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=<?php echo e(env('GTM_ID')); ?>" height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <header class="fixed top-0 left-0 right-0 w-full z-50 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-xs transition-all">
        <div class="h-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-2 xl:gap-4">
            ...
            <a class="flex items-center gap-2.5 group shrink-0" href="<?php echo e(route('home')); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->children->count() > 0): ?>
                        ...
                        <div class="relative" x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false" @click.away="open = false">
                            <a href="<?php echo e(url($item->url ?? '#')); ?>" class="px-2.5 py-1.5 rounded-lg text-[13px] xl:text-sm font-semibold whitespace-nowrap flex items-center gap-0.5 transition-colors <?php echo e((request()->is(ltrim($item->url, '/') . '*') && $item->url != '/') ? 'text-primary font-bold bg-orange-50/80' : 'text-slate-600 hover:text-primary hover:bg-slate-50'); ?>">
                            ...
                            <div x-show="open"
                                ...
                                <div class="p-2 rounded-2xl bg-white/95 backdrop-blur-xl border border-slate-200/90 shadow-[0_20px_45px_rgba(11,19,43,0.12)] space-y-1">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $item->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <a href="<?php echo e(url($child->url ?? '#')); ?>" target="<?php echo e($child->target); ?>" class="flex items-center gap-2.5 p-2 rounded-xl <?php echo e($child->bg_color ?: 'hover:bg-amber-50/60'); ?> text-slate-700 hover:text-amber-600 transition-all group <?php echo e((request()->is(ltrim($child->url, '/'))) ? 'bg-amber-50/70 text-amber-600' : ''); ?>">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($child->icon): ?>
                                                <span class="material-symbols-outlined text-[18px] <?php echo e($child->icon_color ?: 'text-primary group-hover:text-amber-500'); ?>"><?php echo e($child->icon); ?></span>
                                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            <div class="flex flex-col">
                                                <div class="flex items-center gap-1.5">
                                                    <span class="font-headline text-xs font-bold text-navy-base group-hover:text-amber-600"><?php echo e($child->title); ?></span>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($child->badge_text): ?>
                                                        <span class="px-1.5 py-0.5 rounded text-[9px] font-mono font-bold <?php echo e($child->badge_color ?: 'bg-amber-500 text-white'); ?>"><?php echo e($child->badge_text); ?></span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($child->subtitle): ?>
                                                    <span class="text-[10px] text-slate-400"><?php echo e($child->subtitle); ?></span>
                                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                            </div>
                                        </a>
                    ...
                    <?php else: ?>
                        <!-- Single Nav Item -->
                        <a class="px-2.5 py-1.5 rounded-lg text-[13px] xl:text-sm font-semibold whitespace-nowrap transition-colors <?php echo e((request()->is(ltrim($item->url, '/')) || (request()->is('/') && $item->url == '/')) ? 'text-primary font-bold bg-orange-50/80' : 'text-slate-600 hover:text-primary hover:bg-slate-50'); ?>" href="<?php echo e(url($item->url ?? '#')); ?>" target="<?php echo e($item->target); ?>">
            ...
            <div class="flex items-center gap-2.5 shrink-0">
                <a class="inline-flex items-center justify-center px-4 xl:px-5 py-2.5 rounded-full bg-gradient-to-r from-primary via-orange-500 to-accent-amber text-white font-headline text-xs xl:text-sm font-bold shadow-[0_4px_18px_rgba(234,88,12,0.3)] hover:shadow-[0_6px_22px_rgba(234,88,12,0.45)] hover:scale-[1.02] active:scale-[0.98] transition-all whitespace-nowrap" href="<?php echo e(route('contact')); ?>">
                    Yêu Cầu Tư Vấn
                </a>
                <!-- Mobile Menu Button -->
        ...
        <div x-show="mobileMenu" 
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $menuItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($item->children->count() > 0): ?>
                    <!-- Accordion for <?php echo e($item->title); ?> -->
                    <div class="border-t border-slate-100 pt-3" x-data="{ mobileOpen_<?php echo e($item->id); ?>: false }">
                        <button @click="mobileOpen_<?php echo e($item->id); ?> = !mobileOpen_<?php echo e($item->id); ?>" class="w-full flex items-center justify-between font-headline text-sm font-bold text-slate-700 focus:outline-none">
                            <span><?php echo e($item->title); ?></span>
                            <span class="material-symbols-outlined text-[18px] transition-transform duration-200" :class="{ 'rotate-180 text-primary': mobileOpen_<?php echo e($item->id); ?> }">keyboard_arrow_down</span>
                        </button>
                        <div x-show="mobileOpen_<?php echo e($item->id); ?>" x-transition class="pl-3 pt-2 space-y-2 text-xs" style="display: none;">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $item->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $child): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <a href="<?php echo e(url($child->url ?? '#')); ?>" class="block text-slate-600 hover:text-primary py-1 <?php echo e((request()->is(ltrim($child->url, '/') . '*')) ? 'font-bold text-primary' : ''); ?>" @click="mobileMenu = false"><?php echo e($child->title); ?></a>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                <?php else: ?>
                    <!-- Single Link for <?php echo e($item->title); ?> -->
                    <div class="<?php echo e($loop->first ? '' : 'border-t border-slate-100 pt-3'); ?>">
                        <a class="block font-headline text-sm font-bold <?php echo e((request()->is(ltrim($item->url, '/')) || (request()->is('/') && $item->url == '/')) ? 'text-primary' : 'text-slate-700 hover:text-primary'); ?>" href="<?php echo e(url($item->url ?? '#')); ?>" @click="mobileMenu = false">
                            <?php echo e($item->title); ?>
            ...
            <div class="pt-4 border-t border-slate-200">
                <a class="flex items-center justify-center gap-2 py-2.5 rounded-full bg-slate-100 text-xs font-bold text-slate-700" href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', get_setting('company_phone', '0939.363.262'))); ?>">
                    <span class="material-symbols-outlined text-primary text-[18px]">call</span>
                    <span><?php echo e(get_setting('company_phone', '0939.363.262')); ?></span>
                </a>
            </div>
        </div>
    </header>
    ...
    <main class="w-full pt-20">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!request()->routeIs('home') && !request()->routeIs('profile')): ?>
    <!-- ==================== CTA BAND ==================== -->
        <section class="w-full relative overflow-hidden bg-gradient-to-br from-amber-500 via-orange-800 to-navy-base py-16 text-white shadow-2xl animate-gradient-flow" id="cta-contact">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8">
                ...
                <div class="flex flex-col sm:flex-row lg:flex-col items-center gap-4 shrink-0 w-full lg:w-[320px]">
                    <form action="<?php echo e(route('contact.submit')); ?>" method="POST" class="flex flex-col gap-3 w-full bg-white/10 backdrop-blur-md p-5 rounded-2xl border border-white/20 shadow-xl">
                        <?php echo csrf_field(); ?>
                    ...
                    <a class="inline-flex items-center gap-2 text-white/90 font-mono text-xs sm:text-sm hover:text-amber-300 transition-colors font-semibold mt-2" href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', get_setting('company_phone', '0939.363.262'))); ?>">
                        <span class="material-symbols-outlined text-[18px]">phone_in_talk</span>
                        <span>Hotline: <?php echo e(get_setting('company_phone', '0939.363.262')); ?></span>
                    </a>
                </div>
            </div>
        </section>
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-10 lg:gap-12">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10">
                    ...
                    <div class="lg:col-span-4 flex flex-col gap-4">
                        ...
                        <div class="flex items-center gap-3 pt-2 text-slate-400">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(get_setting('social_facebook', 'https://www.facebook.com/truyenthongcuulong/')): ?>
                            <a aria-label="Facebook" target="_blank" rel="noopener noreferrer" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-blue-600 hover:text-white transition-colors" href="<?php echo e(get_setting('social_facebook', 'https://www.facebook.com/truyenthongcuulong/')); ?>">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(get_setting('social_youtube', 'https://www.youtube.com/watch?v=nGvVhO2kDo8')): ?>
                            <a aria-label="YouTube" target="_blank" rel="noopener noreferrer" class="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-red-600 hover:text-white transition-colors" href="<?php echo e(get_setting('social_youtube', 'https://www.youtube.com/watch?v=nGvVhO2kDo8')); ?>">
                    ...
                    <div class="lg:col-span-2 flex flex-col gap-3">
                        ...
                        <ul class="flex flex-col gap-2 font-body text-xs text-slate-400">
                            <li><a class="hover:text-amber-400 transition-colors" href="<?php echo e(route('home')); ?>">Trang chủ</a></li>
                            <li><a class="hover:text-amber-400 transition-colors" href="<?php echo e(route('about')); ?>">Về chúng tôi</a></li>
                            <li><a class="hover:text-amber-400 transition-colors" href="<?php echo e(route('partners')); ?>">Đối tác chiến lược</a></li>
                            <li><a class="hover:text-amber-400 transition-colors" href="<?php echo e(route('clients')); ?>">Khách hàng tiêu biểu</a></li>
                            <li><a class="hover:text-amber-400 transition-colors" href="<?php echo e(route('templates.index')); ?>">Kho giao diện mẫu</a></li>
                            <li><a class="hover:text-amber-400 transition-colors" href="<?php echo e(route('resources.index')); ?>">Tài nguyên số (Download)</a></li>
                            <li><a class="hover:text-amber-400 transition-colors" href="<?php echo e(route('pricing')); ?>">Bảng giá dịch vụ</a></li>
                            <li><a class="hover:text-amber-400 transition-colors" href="<?php echo e(route('careers')); ?>">Tuyển dụng</a></li>
                            <li><a class="hover:text-amber-400 transition-colors" href="<?php echo e(route('projects.index')); ?>">Dự án &amp; Case Studies</a></li>
                            <li><a class="hover:text-amber-400 transition-colors" href="<?php echo e(route('profile')); ?>">Hồ sơ năng lực</a></li>
                            <li><a class="hover:text-amber-400 transition-colors" href="<?php echo e(route('blog.index')); ?>">Tin tức &amp; Xu hướng Media</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="lg:col-span-3 flex flex-col gap-3">
                        ...
                        <form action="<?php echo e(route('contact.submit')); ?>" method="POST" class="flex flex-col gap-2 pt-1">
                            <?php echo csrf_field(); ?>
                ...
                <div class="pt-6 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4 text-slate-500 font-body text-xs text-center md:text-left">
                    ...
                    <div class="flex gap-4">
                        <a class="hover:text-amber-400 transition-colors" href="<?php echo e(route('privacy')); ?>">Chính sách bảo mật</a>
                        <span>•</span>
                        <a class="hover:text-amber-400 transition-colors" href="<?php echo e(route('terms')); ?>">Điều khoản dịch vụ</a>
                    </div>
                </div>
            </div>
        </footer>
    ...
    <div class="floating-contact-wrapper">
        ...
        <a href="tel:<?php echo e(preg_replace('/[^0-9+]/', '', get_setting('company_phone', '0939.363.262'))); ?>" class="btn-floating-wrapper btn-wrapper-call" title="Gọi ngay: <?php echo e(get_setting('company_phone', '0939.363.262')); ?>">
            <div class="btn-floating-inner">
...
<?php /**PATH C:\xampp\htdocs\truyenthongcuulong-laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>