        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="pillar-card pillar-card-media group p-8 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-2xl transition-all duration-300 flex flex-col justify-between relative overflow-hidden">
                ...
                <div class="pt-6 relative z-10">
                    <a href="<?php echo e(route('services.index')); ?>#media" class="inline-flex items-center gap-1.5 text-xs font-headline font-bold text-primary group-hover:translate-x-1 transition-transform">
            ...
            <div class="pillar-card pillar-card-tech group p-8 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-2xl transition-all duration-300 flex flex-col justify-between relative overflow-hidden">
                ...
                <div class="pt-6 relative z-10">
                    <a href="<?php echo e(route('services.index')); ?>#technology" class="inline-flex items-center gap-1.5 text-xs font-headline font-bold text-sky-600 group-hover:translate-x-1 transition-transform">
            ...
            <div class="pillar-card pillar-card-ads group p-8 rounded-3xl bg-white border border-slate-200 shadow-sm hover:shadow-2xl transition-all duration-300 flex flex-col justify-between relative overflow-hidden">
                ...
                <div class="pt-6 relative z-10">
                    <a href="<?php echo e(route('services.index')); ?>#marketing" class="inline-flex items-center gap-1.5 text-xs font-headline font-bold text-amber-600 group-hover:translate-x-1 transition-transform">
...
</section><?php /**PATH C:\xampp\htdocs\truyenthongcuulong-laravel\resources\views/components/home/services.blade.php ENDPATH**/ ?>