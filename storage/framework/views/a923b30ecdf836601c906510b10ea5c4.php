<?php $__env->startSection('title', 'Khách Hàng Tiêu Biểu & Đối Tác Doanh Nghiệp - Truyền Thông Cửu Long'); ?>
<?php $__env->startSection('meta_description', 'Khám phá danh sách các ngân hàng, tập đoàn sản xuất, trường đại học và doanh nghiệp đã tin tưởng đồng hành cùng Truyền Thông Cửu Long.'); ?>
    ...
    <section class="py-12 lg:py-16 bg-surface bg-dot-grid-subtle border-b border-slate-200/80">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
                ...
                <div x-show="activeCategory === 'all' || activeCategory === '<?php echo e($c->industry_category); ?>'"
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-4">
                            <div class="w-10 h-10 rounded-xl bg-orange-50 text-primary border border-orange-200 flex items-center justify-center group-hover:bg-primary group-hover:text-white transition-colors">
                                <span class="material-symbols-outlined text-[22px]"><?php echo e($clientIcons[$c->industry_category] ?? 'business'); ?></span>
                            </div>
                            <span class="px-2 py-0.5 rounded-full bg-slate-100 border border-slate-200 font-mono text-[9px] text-slate-500 font-medium">
                                <?php echo e($clientLabels[$c->industry_category] ?? 'Doanh nghiệp'); ?>
                        ...
                        <p class="font-body text-xs text-slate-500 mt-2 line-clamp-2">
                            Giải pháp: <span class="text-slate-700 font-medium"><?php echo e($c->service_used); ?></span>
                        </p>
                    </div>
...
<script type="application/ld+json">
{
    ...
    "url": "<?php echo e(route('clients')); ?>"
}
</script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\truyenthongcuulong-laravel\resources\views/pages/clients.blade.php ENDPATH**/ ?>