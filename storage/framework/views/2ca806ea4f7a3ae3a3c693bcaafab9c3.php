    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="relative inline-flex items-center p-1.5 rounded-2xl bg-slate-200/85 border border-slate-300/80 shadow-inner backdrop-blur-md max-w-full" 
                ...
                <button type="button" 
                    ...
                    <span class="px-2 py-0.5 rounded-full text-[10px] sm:text-xs font-mono font-bold transition-colors duration-200"
                        ...
                        <?php echo e(count($websiteTemplates)); ?> Demo
                    </span>
                </button>
            </div>
        </div>
                ...
                <div x-show="currentFilter === 'all' || currentFilter === 'tech'" 
                    ...
                    <div class="p-6 flex flex-col gap-2 flex-1 justify-between">
                        ...
                        <div class="pt-4 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500 font-mono">
                            ...
                            <a href="<?php echo e(route('projects.index')); ?>" class="text-sky-600 font-bold">Xem Case Study &rarr;</a>
                        </div>
                    </div>
                </div>
        ...
        <div id="panel-templates" 
                ...
                <div class="flex items-center gap-2 overflow-x-auto pb-3 pt-1 no-scrollbar justify-start lg:justify-center flex-nowrap scroll-smooth">
                    ...
                    <button type="button"
                        ...
                        <span class="px-1.5 py-0.5 rounded-full text-[10px] font-mono"
                            ...
                            <?php echo e($websiteTemplates->count()); ?>

                        </span>
                    </button>

                    <!-- Các Chip Ngành Nghề từ Database (Tự động ẩn ngành 0 bài như Thú Cưng) -->
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $industryFilters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ind): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($ind['has_templates']): ?>
                        <button type="button"
                                @click="currentIndustry = '<?php echo e($ind['slug']); ?>'; displayLimit = 6"
                                :class="currentIndustry === '<?php echo e($ind['slug']); ?>' 
                                    ? 'bg-navy-base text-white border-navy-base shadow-md ring-2 ring-navy-base/20 font-bold' 
                                    : 'bg-white text-slate-700 hover:bg-slate-100 hover:text-navy-base border-slate-200/90'"
                                class="px-4 py-2 rounded-full font-headline text-xs tracking-wide transition-all border shrink-0 flex items-center gap-1.5 cursor-pointer">
                            <span><?php echo e($ind['name']); ?></span>
                            <span class="px-1.5 py-0.5 rounded-full text-[10px] font-mono"
                                  :class="currentIndustry === '<?php echo e($ind['slug']); ?>' ? 'bg-amber-400 text-slate-950 font-bold' : 'bg-slate-100 text-slate-600'">
                                <?php echo e($ind['count']); ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $websiteTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $template): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div x-show="filterTemplate('<?php echo e($template->industry_slug); ?>', <?php echo e($idx); ?>)"
                     x-transition:enter="transition ease-out duration-300"
                    ...
                    <div class="px-4 py-2.5 bg-slate-900 border-b border-slate-800 flex items-center justify-between">
                        ...
                        <span class="font-mono text-[11px] text-slate-400 truncate max-w-[170px] sm:max-w-[200px]">
                            demo.cuulong.tech/<?php echo e($template->slug); ?>
                    ...
                    <div class="web-preview-window h-64 sm:h-72 w-full relative overflow-hidden bg-slate-950 cursor-pointer">
                        <img class="web-preview-scroll-img w-full object-cover" 
                             alt="<?php echo e($template->title); ?>" 
                             src="<?php echo e(asset('storage/' . $template->thumbnail)); ?>"
                        ...
                        <div class="absolute top-3.5 left-3.5 z-10">
                            <span class="px-2.5 py-1 rounded-full bg-slate-950/85 backdrop-blur-md text-amber-400 font-mono text-[11px] font-bold border border-amber-400/30 shadow-md">
                                <?php echo e($template->industry_name); ?>
                    ...
                    <div class="p-5 sm:p-6 flex flex-col gap-3 flex-1 justify-between bg-white">
                        <div>
                            ...
                            <h3 class="font-headline text-base sm:text-lg font-bold text-navy-base group-hover:text-primary transition-colors line-clamp-1">
                                <?php echo e($template->clean_title); ?>

                            </h3>
                            <p class="text-xs sm:text-sm text-slate-500 mt-1 line-clamp-1 leading-relaxed">
                                <?php echo e(!empty($template->summary) ? $template->summary : 'Giao diện ' . $template->industry_name . ' tối ưu trải nghiệm người dùng, tốc độ tải nhanh.'); ?>
                        ...
                        <div class="pt-3.5 border-t border-slate-100 flex items-center gap-2">
                            ...
                            <a href="<?php echo e($template->demo_url ?? route('templates.index', ['industry' => $template->industry_slug, 'preview' => $template->slug])); ?>" 
                               target="_blank" 
                            ...
                            <a href="<?php echo e(route('contact', ['service_interested' => 'Tư vấn mẫu website: ' . $template->clean_title])); ?>" 
            ...
            <div x-show="currentIndustry === 'all' && displayLimit < <?php echo e($websiteTemplates->count()); ?>" class="text-center mt-10">
                <button @click="displayLimit += 6" 
                    ...
                    <span class="px-2 py-0.5 rounded-full bg-orange-100 text-primary font-mono text-xs font-bold" 
                          x-text="`+${ <?php echo e($websiteTemplates->count()); ?> - displayLimit }`"></span>
                </button>
            </div>
...
</section><?php /**PATH C:\xampp\htdocs\truyenthongcuulong-laravel\resources\views/components/home/portfolio.blade.php ENDPATH**/ ?>