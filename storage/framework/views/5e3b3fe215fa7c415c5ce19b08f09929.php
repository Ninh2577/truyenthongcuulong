<?php $__env->startSection('title', 'Trung Tâm Tài Nguyên Số & Tải Miễn Phí - Truyền Thông Cửu Long'); ?>
<?php $__env->startSection('meta_description', 'Tải miễn phí hơn 50+ tài nguyên giá trị: Preset màu DaVinci Resolve, Ebook chiến lược truyền thông, mẫu brief sản xuất TVC, tài liệu biểu mẫu quản trị.'); ?>
...
<div class="w-full selection:bg-amber-500 selection:text-slate-900" x-data="{
    ...
    submitLead() {
        ...
        fetch('<?php echo e(route('resources.download')); ?>', {
            method: 'POST',
            headers: {
    ...
    <section class="relative pt-32 pb-12 lg:pt-36 lg:pb-16 bg-surface-low bg-dot-grid-subtle border-b border-slate-200/80 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <!-- Search Input -->
                <form action="<?php echo e(route('resources.index')); ?>" method="GET" class="w-full md:w-80 shrink-0">
                    <div class="relative flex items-center">
                        <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="Tìm tên tài liệu, ebook, LUTs..." 
    ...
    <section class="py-12 lg:py-16 bg-surface bg-dot-grid-subtle border-b border-slate-200/80">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between gap-4 mb-8">
                ...
                <span class="text-xs font-mono text-slate-500 hidden sm:inline">Tổng cộng: <?php echo e($resources->total()); ?> tài liệu</span>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $resources; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="group rounded-3xl overflow-hidden bg-white border border-slate-200/90 hover:border-amber-400/50 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between p-6">
                    ...
                    <div class="flex flex-col gap-4">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <p class="font-body text-xs text-slate-600 line-clamp-2 leading-relaxed">
                                <?php echo e($item->summary ?: 'Tài liệu hướng dẫn và bộ công cụ chuyên biệt giúp tối ưu hiệu suất công việc và nâng cao năng lực sản xuất số.'); ?>
                        ...
                        <div class="flex items-center gap-3 pt-3 text-[11px] font-mono text-slate-500 border-t border-slate-100">
                            <span class="flex items-center gap-1">
                                ...
                                <?php echo e($item->views + 120); ?> lượt tải
                            </span>
                            <span>•</span>
                    ...
                    <div class="pt-5 mt-4 border-t border-slate-100">
                        <button type="button" @click="openDownload('<?php echo e($item->slug); ?>', '<?php echo e(addslashes($item->title)); ?>')" 
                ...
                <div class="col-span-3 text-center py-20 bg-white rounded-3xl border border-slate-200">
                    ...
                    <a href="<?php echo e(route('resources.index')); ?>" class="mt-4 inline-flex items-center gap-2 px-6 py-2.5 rounded-full bg-amber-400 text-slate-950 font-headline text-xs font-bold hover:bg-amber-300 transition-all">
...
<script type="application/ld+json">
{
    ...
    "url": "<?php echo e(route('resources.index')); ?>",
    "provider": {
        "@type": "Organization",
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\truyenthongcuulong-laravel\resources\views/resources/index.blade.php ENDPATH**/ ?>