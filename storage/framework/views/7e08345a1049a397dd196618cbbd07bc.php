<?php $__env->startSection('title', 'Thiết Kế & Lập Trình Web/App Chuyên Nghiệp - Truyền Thông Cửu Long'); ?>
<?php $__env->startSection('meta_description', 'Dịch vụ thiết kế website và phát triển web app doanh nghiệp chuẩn SEO, kiến trúc clean-code chịu tải cao, bàn giao trọn gói mã nguồn.'); ?>
...
<section class="relative w-full overflow-hidden bg-surface-low bg-dot-grid-subtle pt-32 pb-12 lg:pt-36 lg:pb-16 border-b border-slate-200/80">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <nav class="flex items-center gap-2 text-xs font-mono text-slate-400 mb-6" aria-label="Breadcrumb">
            ...
            <a href="<?php echo e(route('services.index')); ?>" class="hover:text-amber-400 transition-colors">Dịch vụ</a>
            <span class="text-slate-600">/</span>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div class="lg:col-span-8 flex flex-col gap-5">
                ...
                <div class="flex flex-wrap items-center gap-4 pt-3">
                    <a href="<?php echo e(route('pricing')); ?>" class="px-6 py-3.5 rounded-xl bg-amber-400 hover:bg-amber-300 text-slate-950 font-headline text-xs sm:text-sm font-extrabold shadow-lg shadow-amber-400/20 transition-all flex items-center gap-2">
            ...
            <div class="lg:col-span-4">
                <div class="p-6 rounded-3xl bg-[#0F172A] text-white border border-slate-700/80 shadow-xl flex flex-col gap-5 relative overflow-hidden">
                    ...
                    <div class="pt-2">
                        <a href="<?php echo e(route('contact')); ?>?service=web-app" class="w-full py-2.5 rounded-xl bg-white/10 hover:bg-white/20 text-white font-headline text-xs font-bold transition-all text-center block">
...
<section id="case-studies" class="w-full bg-surface bg-dot-grid-subtle py-12 lg:py-16 border-b border-slate-200/80">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 lg:mb-12">
            ...
            <a href="<?php echo e(route('projects.index')); ?>?group=technology" class="inline-flex items-center gap-2 text-primary font-headline text-sm font-bold hover:underline">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $featuredTechProjects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <?php
            ...
            <div class="group rounded-3xl overflow-hidden border border-slate-200/90 shadow-sm hover:shadow-xl hover:shadow-slate-900/10 hover:-translate-y-1 transition-all duration-300 flex flex-col bg-white">
                ...
                <div class="relative overflow-hidden aspect-[4/3] xl:aspect-[16/10] bg-slate-900 border-b border-slate-100">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hasThumb): ?>
                    ...
                    <?php else: ?>
                        ...
                        <div class="w-full h-full bg-gradient-to-br <?php echo e($gradient); ?> flex items-center justify-center relative overflow-hidden">
                    ...
                    <div class="absolute bottom-3 left-3 z-10">
                        <span class="inline-flex items-center gap-1.5 text-[10px] font-mono font-bold px-2.5 py-1 rounded-full <?php echo e($statusText); ?> <?php echo e($statusBg); ?> border backdrop-blur-md shadow-sm">
                            <span class="w-1.5 h-1.5 rounded-full <?php echo e($statusDot); ?> animate-pulse shrink-0"></span>
                ...
                <div class="p-5 flex flex-col gap-3 flex-1 justify-between">
                    ...
                    <div class="pt-3 border-t border-slate-100 flex items-center justify-between gap-2">
                        <span class="font-mono text-[10px] text-slate-500 leading-tight"><?php echo e($techStack); ?></span>
                        <a href="<?php echo e(route('contact', ['service' => 'Tư Vấn Giải Pháp: ' . $project->title])); ?>"
...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($featuredTemplates) && $featuredTemplates->isNotEmpty()): ?>
<section x-data="{ activeFilter: 'all' }" class="w-full bg-surface bg-dot-grid-subtle py-12 lg:py-16 border-b border-slate-200/80">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8 lg:mb-10">
            ...
            <a href="<?php echo e(route('templates.index')); ?>" class="inline-flex items-center gap-2 text-sky-700 font-headline text-sm font-bold hover:underline">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $featuredTemplates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
                $slug = $tpl->slug;
            ...
            ?>
            <div x-show="activeFilter === 'all' || activeFilter === '<?php echo e($filterKey); ?>'"
                ...
                <div class="w-full h-full relative overflow-hidden bg-slate-950">
                    ...
                    <div class="absolute top-3.5 right-3.5 z-20">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($tierBadge === 'Miễn phí tùy chỉnh'): ?>
                            <span class="inline-flex items-center gap-0.5 sm:gap-1 px-2 sm:px-3 py-1 rounded-full bg-amber-400 text-slate-950 font-headline text-[10px] sm:text-[11px] font-extrabold shadow-md tracking-tight">
                                ...
                                <span class="hidden sm:inline"><?php echo e($tierBadge); ?></span>
                    ...
                    <div class="absolute inset-x-0 bottom-0 pt-32 pb-4 px-4 flex flex-col gap-2.5 z-20 pointer-events-auto" style="background: linear-gradient(to top, rgba(2, 6, 23, 0.95) 0%, rgba(2, 6, 23, 0.8) 45%, transparent 100%);">
                        <div>
                            <h3 class="font-headline text-base sm:text-lg font-bold text-white tracking-tight leading-snug drop-shadow-md group-hover:text-amber-300 transition-colors">
                                <?php echo e($titleDisplay); ?>

                            </h3>
                            <p class="font-body text-xs text-slate-300 font-medium line-clamp-1 mt-0.5">
                                <?php echo e($subtitleDisplay); ?>

                            </p>
                        </div>
                        
                        <a href="<?php echo e(route('templates.index', ['industry' => $indFilterSlug])); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\truyenthongcuulong-laravel\resources\views/services/web-app.blade.php ENDPATH**/ ?>