<?php $__env->startSection('title', 'Dịch Vụ Quảng Cáo Số & Truyền Thông Đa Kênh - Truyền Thông Cửu Long'); ?>
<?php $__env->startSection('meta_description', 'Giải pháp chạy quảng cáo Google, Facebook, TikTok và SEO tổng thể kết hợp tư liệu hình ảnh chất lượng cao tối ưu chuyển đổi doanh thu.'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div class="lg:col-span-8 flex flex-col gap-5">
                ...
                <div class="flex flex-wrap items-center gap-4 pt-3">
                    <a href="<?php echo e(route('contact')); ?>?service=marketing" class="px-6 py-3 rounded-xl bg-gradient-to-r from-primary to-accent-coral text-white font-headline text-xs sm:text-sm font-bold shadow-lg shadow-primary/25 hover:brightness-110 transition-all flex items-center gap-2">
...
<section id="results" class="w-full bg-surface-low py-16 lg:py-20 border-b border-slate-200/80 bg-dot-grid-subtle relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="flex flex-col lg:flex-row items-end justify-between gap-8 mb-12 lg:mb-16">
            ...
            <div class="shrink-0">
                <a href="<?php echo e(route('pricing')); ?>" class="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-white text-navy-base font-headline text-sm font-bold border border-slate-200 hover:bg-slate-50 shadow-sm transition-all cursor-pointer">
...
<section class="w-full bg-[#080C16] py-16 lg:py-24 relative overflow-hidden text-white border-t border-white/10">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="<?php echo e(route('pricing')); ?>" class="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-white text-navy-base font-headline text-sm font-bold shadow-xl hover:scale-105 transition-all flex items-center justify-center gap-2">
                <span>Xem Bảng Giá Chi Tiết</span>
                <span class="material-symbols-outlined text-[18px]">receipt_long</span>
            </a>
            <a href="<?php echo e(route('contact')); ?>?service=marketing" class="w-full sm:w-auto px-8 py-3.5 rounded-xl bg-emerald-500 text-white font-headline text-sm font-bold shadow-xl hover:scale-105 hover:bg-emerald-400 transition-all flex items-center justify-center gap-2">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\truyenthongcuulong-laravel\resources\views/services/marketing.blade.php ENDPATH**/ ?>