<?php $__env->startSection('title', 'Booking Ekip Quay Phim & Chụp Ảnh Hỏa Tốc - Truyền Thông Cửu Long'); ?>
<?php $__env->startSection('meta_description', 'Dịch vụ cho thuê ekip quay phim điện ảnh 4K, chụp ảnh sự kiện và bay flycam chuyên nghiệp tác nghiệp theo buổi, trọn gói ngày tại Cần Thơ, TP.HCM và Miền Tây.'); ?>
    ...
    <section class="relative py-12 lg:py-16 bg-surface-low bg-dot-grid-subtle border-b border-slate-200/80 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div class="p-8 sm:p-12 rounded-3xl bg-[#0F172A] border border-amber-400/30 shadow-2xl relative overflow-hidden">
                ...
                <form action="<?php echo e(route('contact.submit')); ?>" method="POST" class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\truyenthongcuulong-laravel\resources\views/services/booking.blade.php ENDPATH**/ ?>