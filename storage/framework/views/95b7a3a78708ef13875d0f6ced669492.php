<?php $__env->startSection('title', 'Mạng Lưới Đối Tác Chiến Lược - Truyền Thông Cửu Long'); ?>
<?php $__env->startSection('meta_description', 'Danh sách các đối tác hạ tầng công nghệ và du lịch lữ hành đồng hành bền vững cùng Truyền Thông Cửu Long.'); ?>
                    ...
                    <div class="relative w-full max-w-[420px] h-[360px] sm:h-[390px]">
                        ...
                        <div class="absolute top-2 left-1 w-[220px] sm:w-[250px] rounded-2xl p-2 bg-[#0C1424]/95 border border-white/15 shadow-2xl shadow-black/80 transform -rotate-6 hover:rotate-0 hover:z-30 hover:scale-105 transition-all duration-500 cursor-pointer group">
                            <div class="w-full h-28 sm:h-32 rounded-xl overflow-hidden bg-slate-900 relative">
                                <img src="<?php echo e(asset('images/partners/lang_sen_real.jpg')); ?>" alt="KBT Đất Ngập Nước Láng Sen" class="editorial-film-grade w-full h-full object-cover">
                        ...
                        <div class="absolute top-5 right-1 w-[210px] sm:w-[240px] rounded-2xl p-2 bg-[#0C1424]/95 border border-white/15 shadow-2xl shadow-black/80 transform rotate-6 hover:rotate-0 hover:z-30 hover:scale-105 transition-all duration-500 cursor-pointer group">
                            <div class="w-full h-28 sm:h-32 rounded-xl overflow-hidden bg-slate-900 relative">
                                <img src="<?php echo e(asset('images/partners/long_trekking_real.jpg')); ?>" alt="Long Trekking Trails" class="editorial-film-grade w-full h-full object-cover">
                        ...
                        <div class="absolute bottom-3 left-1/2 -translate-x-1/2 w-[260px] sm:w-[290px] rounded-2xl p-2.5 bg-[#10192D] border border-amber-400/40 shadow-[0_20px_45px_rgba(0,0,0,0.85)] transform -rotate-2 hover:rotate-0 hover:z-30 hover:scale-105 transition-all duration-500 cursor-pointer group z-20">
                            <div class="w-full h-32 sm:h-36 rounded-xl overflow-hidden bg-slate-900 relative">
                                <img src="<?php echo e(asset('images/partners/lien_minh_dbscl_opt.jpg')); ?>" alt="Liên Minh Du Lịch ĐBSCL" class="editorial-film-grade w-full h-full object-cover">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div class="mb-14">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $topPartners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="partner-card-stagger partner-card-base partner-card-top-feature rounded-3xl overflow-hidden flex flex-col justify-between group" data-index="<?php echo e($index); ?>">
                        
                        
                        <div class="relative w-full h-72 sm:h-80 overflow-hidden bg-slate-900">
                            <img data-src="<?php echo e($resolveImageUrl($partner->image, $partner->logo)); ?>" 
                                 src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 10'%3E%3C/svg%3E"
                                 alt="<?php echo e($partner->name); ?> - <?php echo e($partner->category); ?>"
                                 loading="lazy"
                                 decoding="async"
                                 width="600"
                                 height="400"
                            ...
                            <div class="absolute top-4 right-4 z-10 w-11 h-11 rounded-2xl bg-amber-950/85 border border-amber-400/60 text-amber-300 flex items-center justify-center shadow-lg shadow-amber-950/50 backdrop-blur-md group-hover:scale-110 transition-transform duration-300">
                                <span class="material-symbols-outlined text-[22px] select-none"><?php echo e($partnerIcons[$partner->slug] ?? 'star'); ?></span>
                            </div>
                            ...
                            <div class="absolute bottom-4 left-5 right-5 z-10">
                                <p class="font-mono text-xs text-amber-300 font-bold mb-1 tracking-wide flex items-center gap-1.5">
                                    <span class="w-1.5 h-1.5 rounded-full bg-amber-400"></span>
                                    <span><?php echo e($partner->category); ?></span>
                                </p>
                        ...
                        <div class="p-6 pt-4 flex-1 flex flex-col justify-between">
                            ...
                            <div class="pt-4 mt-5 border-t border-slate-100 flex items-center justify-between text-xs font-mono text-slate-500">
                                <span class="text-amber-700 font-medium"><?php echo e($partner->tagline); ?></span>
            ...
            <div class="mb-14 pt-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $goldPartners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php 
                        $bgImageSrc = $resolveImageUrl($partner->image, $partner->logo); 
                        $logoOnlyUrl = $resolveImageUrl($partner->logo);
                    ?>
                    <div class="partner-card-stagger partner-card-base partner-card-gold-medium rounded-3xl overflow-hidden flex flex-col justify-between group" data-index="<?php echo e($index + 3); ?>">

                        
                        <div class="relative w-full h-72 sm:h-80 overflow-hidden bg-slate-900">

                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($bgImageSrc): ?>
                                <img data-src="<?php echo e($bgImageSrc); ?>"
                                     src="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 16 10'%3E%3C/svg%3E"
                                     alt="<?php echo e($partner->name); ?> - <?php echo e($partner->category); ?>"
                                     loading="lazy"
                                     decoding="async"
                            ...
                            <div class="absolute top-4 right-4 z-10 w-11 h-11 rounded-2xl bg-[#1D140C]/85 border border-amber-600/60 text-amber-400 flex items-center justify-center shadow-lg shadow-amber-950/50 backdrop-blur-md group-hover:scale-110 transition-transform duration-300">
                                <span class="material-symbols-outlined text-[22px] select-none"><?php echo e($partnerIcons[$partner->slug] ?? 'verified'); ?></span>
                            </div>

                            
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($logoOnlyUrl): ?>
                            <div class="absolute bottom-16 left-5 z-10">
                                <div class="flex items-center justify-center h-12 px-3 rounded-xl bg-white/10 backdrop-blur-md border border-white/20 shadow-lg">
                                    <img src="<?php echo e($logoOnlyUrl); ?>" alt="<?php echo e($partner->name); ?> logo"
            ...
            <div class="pt-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $strategicPartners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $partner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="partner-card-stagger partner-card-strategic-compact rounded-2xl p-3.5 sm:p-4 flex flex-row items-center gap-4 group" data-index="<?php echo e($index + 6); ?>">
                        ...
                        <div class="w-20 h-20 sm:w-24 sm:h-24 rounded-xl overflow-hidden shrink-0 bg-slate-900 border border-slate-700/60 relative">
                            ...
                            <div class="absolute bottom-1.5 right-1.5 w-6 h-6 rounded-md bg-slate-900/90 border border-slate-700 text-slate-300 flex items-center justify-center">
                                <span class="material-symbols-outlined text-[14px]"><?php echo e($partnerIcons[$partner->slug] ?? 'business'); ?></span>
                            </div>
                        </div>
...
<script type="application/ld+json">
{
    ...
    "url": "<?php echo e(route('partners')); ?>"
}
</script>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\truyenthongcuulong-laravel\resources\views/pages/partners.blade.php ENDPATH**/ ?>