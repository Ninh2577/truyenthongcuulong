<?php $__env->startSection('title', 'Dự Án & Case Studies Tiêu Biểu - Truyền Thông Cửu Long'); ?>
<?php $__env->startSection('meta_description', 'Khám phá các dự án sản xuất phim TVC 4K, phim tài liệu doanh nghiệp và hệ thống website đã triển khai thành công tại Truyền Thông Cửu Long.'); ?>
    ...
    <section class="relative w-full overflow-hidden pt-32 pb-14 lg:pt-36 lg:pb-20 border-b border-slate-200/80 bg-surface-low bg-dot-grid-subtle">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <nav class="flex items-center gap-2 text-xs font-headline text-slate-400 mb-6" aria-label="Breadcrumb">
                <a href="<?php echo e(route('home')); ?>" class="hover:text-primary transition-colors flex items-center gap-1">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between gap-6 pb-2">
                ...
                <!-- Search Input Form -->
                <form action="<?php echo e(route('projects.index')); ?>" method="GET" class="w-full md:w-80 shrink-0">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('group')): ?>
                        <input type="hidden" name="group" value="<?php echo e(request('group')); ?>">
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div class="relative flex items-center">
                        <input type="text" name="q" value="<?php echo e(request('q')); ?>" placeholder="Tìm tên dự án, khách hàng..." 
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-wrap items-center justify-between gap-4 mb-10 pb-4 border-b border-slate-200">
                <div class="flex items-center gap-2 overflow-x-auto pb-1 no-scrollbar">
                    <a href="<?php echo e(route('projects.index', ['q' => request('q')])); ?>" 
                        class="px-5 py-2.5 rounded-full text-xs font-headline font-bold whitespace-nowrap transition-all <?php echo e(empty(request('group')) || request('group') === 'all' ? 'bg-navy-base text-amber-400 shadow-md shadow-navy-base/20 border border-amber-400/30' : 'bg-white text-slate-600 hover:text-navy-base border border-slate-200'); ?>">
                        Tất Cả Dự Án (<?php echo e($totalCount ?? $caseStudies->total()); ?>)
                    </a>
                    <a href="<?php echo e(route('projects.index', ['group' => 'media', 'q' => request('q')])); ?>" 
                        class="px-5 py-2.5 rounded-full text-xs font-headline font-bold whitespace-nowrap transition-all <?php echo e(request('group') === 'media' ? 'bg-navy-base text-amber-400 shadow-md shadow-navy-base/20 border border-amber-400/30' : 'bg-white text-slate-600 hover:text-navy-base border border-slate-200'); ?>">
                        Sản Xuất Điện Ảnh &bull; Media (<?php echo e($mediaCount ?? 0); ?>)
                    </a>
                    <a href="<?php echo e(route('projects.index', ['group' => 'technology', 'q' => request('q')])); ?>" 
                        class="px-5 py-2.5 rounded-full text-xs font-headline font-bold whitespace-nowrap transition-all <?php echo e(request('group') === 'technology' ? 'bg-navy-base text-amber-400 shadow-md shadow-navy-base/20 border border-amber-400/30' : 'bg-white text-slate-600 hover:text-navy-base border border-slate-200'); ?>">
                        Nền Tảng Công Nghệ &bull; TechLab (<?php echo e($techCount ?? 0); ?>)
                    </a>
                </div>

                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request('group') || request('q')): ?>
                <a href="<?php echo e(route('projects.index')); ?>" class="text-xs font-mono font-bold text-primary hover:underline flex items-center gap-1">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $caseStudies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="rounded-3xl overflow-hidden bg-white border border-slate-200/90 shadow-sm hover:shadow-xl transition-all duration-300 flex flex-col justify-between group">
                    ...
                    <div class="h-60 w-full relative overflow-hidden bg-navy-base flex items-center justify-center">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($youtubeId): ?>
                            <img src="https://img.youtube.com/vi/<?php echo e($youtubeId); ?>/maxresdefault.jpg" alt="<?php echo e($project->title); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 opacity-90" onerror="this.src='https://img.youtube.com/vi/<?php echo e($youtubeId); ?>/hqdefault.jpg'">
                        <?php elseif($project->thumbnail): ?>
                            <img src="<?php echo e(asset('storage/' . $project->thumbnail)); ?>" alt="<?php echo e($project->title); ?>" class="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500 opacity-90">
                            <!-- Watermark for AI generated mockups -->
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(Str::contains($project->thumbnail, 'mockup_')): ?>
                        ...
                        <?php elseif($project->video_url): ?>
                            <iframe src="<?php echo e($project->video_url); ?>?controls=1&showinfo=0&rel=0&modestbranding=1" class="w-full h-full absolute inset-0 object-cover z-0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        <?php else: ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($project->video_url && ($project->thumbnail || $youtubeId)): ?>
                        <button type="button" @click="openVideo('<?php echo e($project->video_url); ?>')" class="absolute inset-0 m-auto w-14 h-14 rounded-full bg-primary/95 text-white flex items-center justify-center shadow-lg ring-4 ring-orange-400/40 group-hover:scale-110 transition-transform cursor-pointer z-10">
                        ...
                        <div class="absolute top-3.5 left-3.5 pointer-events-none z-10">
                            <span class="px-3.5 py-1 rounded-full bg-navy-base/85 backdrop-blur-md text-amber-400 font-mono text-xs font-bold border border-amber-400/30">
                                <?php echo e($project->client_name ?: 'Khách hàng đối tác'); ?>
                        ...
                        <div class="absolute bottom-3.5 right-3.5 pointer-events-none z-10">
                            <span class="px-3 py-0.5 rounded-full bg-black/60 backdrop-blur-md text-white font-mono text-[11px]">
                                <?php echo e($project->year ?: '2024 - 2025'); ?>
                    ...
                    <div class="p-6 flex flex-col gap-3 flex-1 justify-between">
                        <div class="flex flex-col gap-2">
                            <div class="flex items-center gap-2">
                                <span class="px-2 py-0.5 rounded text-[10px] font-mono font-bold uppercase <?php echo e($project->group === 'technology' ? 'bg-sky-100 text-sky-700' : 'bg-orange-100 text-primary'); ?>">
                                    <?php echo e($project->group === 'technology' ? 'Hệ Thống Số' : 'Sản Xuất Media'); ?>
                            ...
                            <p class="font-body text-xs text-slate-600 line-clamp-3 leading-relaxed">
                                <?php echo e($project->summary ?: 'Dự án được lên kế hoạch sản xuất và kiểm soát chất lượng bởi đội ngũ chuyên môn Truyền Thông Cửu Long.'); ?>
                        ...
                        <div class="grid grid-cols-<?php echo e(count($metrics)); ?> gap-2 pt-3 border-t border-slate-100 text-center min-h-[70px]">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $metrics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $metric): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="flex flex-col justify-center p-2 rounded-xl bg-slate-50 h-full">
                                <span class="block font-headline text-sm font-extrabold <?php echo e($index === 0 ? 'text-primary' : 'text-emerald-600'); ?>"><?php echo e($metric['value']); ?></span>
                                <span class="text-[10px] text-slate-600 font-bold mt-0.5"><?php echo e($metric['label']); ?></span>
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($metric['context'])): ?>
                                <span class="text-[9px] text-slate-400 font-medium mt-1 leading-tight line-clamp-1"><?php echo e($metric['context']); ?></span>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            </div>
                        ...
                        <div class="pt-3 border-t border-slate-100 flex items-center justify-between text-xs font-headline font-bold text-primary">
                            <a href="<?php echo e(route('projects.show', $project->slug)); ?>" class="inline-flex items-center gap-1 hover:underline">
                ...
                <div class="col-span-3 text-center py-16 bg-white rounded-3xl border border-slate-200">
                    ...
                    <a href="<?php echo e(route('projects.index')); ?>" class="inline-flex items-center gap-1 text-xs font-bold text-primary mt-4 hover:underline">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\truyenthongcuulong-laravel\resources\views/projects/index.blade.php ENDPATH**/ ?>