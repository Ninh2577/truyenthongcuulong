<?php $__env->startSection('title', $service->title . ' - Truyền Thông Cửu Long'); ?>
<?php $__env->startSection('meta_description', $service->summary ?: 'Dịch vụ ' . $service->title . ' chuyên nghiệp tại Truyền Thông Cửu Long.'); ?>
...
<div class="w-full bg-surface bg-dot-grid-subtle pt-28 pb-20 border-b border-slate-200/60">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col gap-16">
        ...
        <nav class="flex items-center gap-2 text-xs font-headline text-slate-500">
            <a href="<?php echo e(route('home')); ?>" class="hover:text-primary">Trang chủ</a>
            <span>/</span>
            <a href="<?php echo e(route('services.index')); ?>" class="hover:text-primary">Dịch vụ</a>
            <span>/</span>
            <span class="text-navy-base font-bold"><?php echo e($service->title); ?></span>
        </nav>
        ...
        <div class="p-8 sm:p-12 rounded-3xl bg-navy-base text-white border border-slate-700 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-10 relative overflow-hidden">
            ...
            <div class="flex flex-col gap-4 max-w-2xl relative z-10">
                ...
                <p class="font-body text-slate-300 text-sm sm:text-base leading-relaxed">
                    <?php echo e($service->summary ?: 'Giải pháp chuyên sâu được thiết kế riêng biệt nhằm tối ưu hóa hiệu quả nhận diện thương hiệu và chuyển đổi doanh thu cho doanh nghiệp.'); ?>
                ...
                <div class="flex flex-wrap items-center gap-4 pt-2">
                    ...
                    <a href="<?php echo e(route('projects.index')); ?>" class="px-6 py-3.5 rounded-full bg-white/10 hover:bg-white/20 text-white font-headline text-xs font-bold transition-all">
            ...
            <div class="w-full lg:w-96 rounded-2xl overflow-hidden bg-slate-800 border border-white/10 shadow-lg shrink-0">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($service->thumbnail): ?>
                <img src="<?php echo e(asset('storage/' . $service->thumbnail)); ?>" alt="<?php echo e($service->title); ?>" class="w-full h-64 object-cover">
                <?php else: ?>
                <div class="w-full h-64 flex flex-col items-center justify-center bg-gradient-to-br from-navy-surface to-navy-card p-6 text-center text-slate-400">
                    ...
                    <span class="font-headline text-sm font-bold text-white"><?php echo e($service->title); ?></span>
                </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div class="lg:col-span-7 flex flex-col gap-10">
                <div class="prose prose-slate max-w-none text-slate-700 leading-relaxed font-body text-base">
                    <?php echo $service->content ?: '<p>Quy trình triển khai dịch vụ được kiểm soát nghiêm ngặt theo các tiêu chuẩn kỹ thuật hàng đầu, đảm bảo tiến độ bàn giao chính xác và bảo hành dài hạn.</p>'; ?>
            ...
            <div id="booking-form" class="lg:col-span-5 p-8 rounded-3xl bg-white border-2 border-orange-200 shadow-xl flex flex-col gap-5 sticky top-28">
                ...
                <form action="<?php echo e(route('contact.submit')); ?>" method="POST" class="flex flex-col gap-3.5">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="service_interested" value="<?php echo e($service->title); ?>">
                    <div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\truyenthongcuulong-laravel\resources\views/services/show.blade.php ENDPATH**/ ?>