...
var zoom = 1;
var zoomStep = 0.2;
var bookSliderjs = document.getElementById("container-book-slider");
document.getElementById("btnZoomIn").addEventListener("click", function() {
	zoom += zoomStep;
	bookSliderjs.style.transform = "scale("+ zoom +")";
});
...
bookSliderjs.addEventListener("dblclick", function() {
	if(zoom < 1){
		zoom += zoomStep;
		bookSliderjs.style.transform = "scale("+ zoom +")";
	}else{
...
function openFullscreen() {
	if (bookSliderjs.requestFullscreen) {
		bookSliderjs.requestFullscreen();
	} else if (bookSliderjs.webkitRequestFullscreen) { 
		bookSliderjs.webkitRequestFullscreen();
	} else if (bookSliderjs.msRequestFullscreen) { 
	  bookSliderjs.msRequestFullscreen();
	}
  }